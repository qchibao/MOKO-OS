...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Phases 1-5 are QEMU-validated: MOKO compositor window management, real Control Center backends, capability-based libinput policy, safe AI request/response, and the sandboxed native MOKO Browser. BIOS/UEFI remain healthy; consumer UI, desktop usability, resume work and physical MacBook validation remain. |
