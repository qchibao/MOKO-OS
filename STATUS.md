...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Phases 1-2 are QEMU-validated: MOKO compositor window management plus a MOKO Control Center backed by NetworkManager, BlueZ, PipeWire/WirePlumber, kernel backlight/battery data and Power Profiles. BIOS/UEFI remain 3/3; physical radio, backlight, battery and suspend validation is still required. |
