...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Phase 1 window management is QEMU-validated: MOKO compositor, simultaneous apps, real move/resize/state controls, Dock restore, snap and Alt+Tab pass BIOS/UEFI regression gates. Cage remains the Safe Graphics fallback. Control Center and later phases remain open. |
