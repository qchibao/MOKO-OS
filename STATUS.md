...
| MOKO-010 Live USB readiness | IN PROGRESS | Add MOKO boot profiles, UEFI/safe-graphics validation, storage safety guard, release metadata and the physical test checklist. |
