...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Physical hotfix H1-H7 is implemented, including quiet boot/black shutdown, hardware usability fixes, visual rebuilds and the verified Live `.deb` flow. H8 automated release gates and physical MacBook Pro 2015 validation remain required before completion. |
...
the physical-test specification in phases H1-H7. Normal boot and shutdown are
...
disabled. H8 runs from a clean commit and produces the replacement artifact;
the Intel MacBook Pro 2015 remains the final authority for physical validation.
