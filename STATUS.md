...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Phases 1-5 are QEMU-validated. Phase 6 consumer UI cleanup passes Debian 13 unit/render validation and awaits its committed ISO regression run. Desktop usability, resume work and physical MacBook validation remain. |
