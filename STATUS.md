...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Phases 1-3 are QEMU-validated: MOKO compositor window management, real Control Center backends and capability-based libinput trackpad policy with Shell runtime controls. BIOS/UEFI remain 3/3; physical MacBook input, radio, backlight, battery and suspend validation is still required. |
