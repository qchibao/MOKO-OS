...
| MOKO-011 v0.1.1 Hardware & Usability Preview | IN PROGRESS | Phases 1-4 are QEMU-validated: MOKO compositor window management, real Control Center backends, capability-based libinput policy, and safe AI request/response states and intents. BIOS/UEFI remain healthy; physical MacBook input, radio, backlight, battery and suspend validation is still required. |
