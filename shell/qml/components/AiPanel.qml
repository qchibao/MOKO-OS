...
GlassPanel {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            MokoGlyph { anchors.fill: parent; anchors.margins: 18; kind: "ai" }
        }

        Text { Layout.alignment: Qt.AlignHCenter; text: "<font color='#3F7CFF'>Hello,</font> MOKO."; textFormat: Text.RichText; color: "#12161C"; font.pixelSize: 26 }
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                Text { anchors.left: parent.left; anchors.leftMargin: 14; anchors.top: parent.top; anchors.topMargin: 12; text: modelData[0]; color: "#2B3541"; font.pixelSize: 12; font.bold: true }
                Text { anchors.left: parent.left; anchors.leftMargin: 14; anchors.top: parent.top; anchors.topMargin: 32; text: modelData[1]; color: "#7A8795"; font.pixelSize: 9 }
                MokoGlyph { anchors.right: parent.right; anchors.rightMargin: 12; anchors.verticalCenter: parent.verticalCenter; width: 28; height: 28; kind: modelData[2] }
            }
        }
        ...
        Text { Layout.alignment: Qt.AlignHCenter; text: "Developer Preview • AI actions are not connected yet"; color: "#94A0AE"; font.pixelSize: 8 }
    }
}
