...
grep -Fq 'QCoreApplication::postEvent(' "$ROOT/shell/src/windowmanager.cpp"
grep -Fq 'Qt::HighEventPriority' "$ROOT/shell/src/windowmanager.cpp"
grep -Fq 'startWaylandDispatchWakeup();' "$ROOT/shell/src/windowmanager.cpp"
grep -Fq 'stopWaylandDispatchWakeup();' "$ROOT/shell/src/windowmanager.cpp"
